...
exports.deleteRole = exports.update = exports.get = exports.create = void 0;
...
exports.deleteRole = (0, catchAsync_1.default)(async (req, res, next) => {
    console.log("test", req.body, req.params, req.query);
    const result = await roleService.deleteRole(req.query.id);
    res.status(200).json({ data: result });
});
